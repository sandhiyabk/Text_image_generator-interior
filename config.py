...
BUDGET_RANGES = {
    "Low (under ₹50,000)": 50000,
    "Medium (₹50k–₹1.5L)": 150000,
    "High (₹1.5L–₹3L)": 300000,
    "Luxury (₹3L+)": 600000
}
FURNITURE_CATEGORIES = ["sofa", "dining_table", "bed", "wardrobe", "coffee_table",
                        "bookshelf", "tv_unit", "study_desk", "accent_chair", "lighting"]

# --- Per-room budget allocations (each room's weights sum exactly to 1.0) ---
BUDGET_ALLOCATION = {
